...
EXP_GROUPS = [
    ...
    ('SPS\\textsubscript{VAE}, $K$=4 (Ours)', 'scale_singleInst_1dim_0'),
    # ('SPS-VAE', 'scale_singleInst_1dim_1'),
    # ('SPS-VAE', 'scale_singleInst_1dim_2'),
    # ('SPS-VAE', 'scale_singleInst_1dim_3'),
    # ('SPS-VAE', 'scale_singleInst_1dim_4'),
    # ('SPS-VAE', 'scale_singleInst_1dim_5'),
    # ('SPS-VAE', 'scale_singleInst_1dim_6'),
    # ('SPS-VAE', 'scale_singleInst_1dim_7'),
    # ('SPS-VAE', 'scale_singleInst_1dim_8'),
    # ('SPS-VAE', 'scale_singleInst_1dim_9'),
    # ('SPS-AE', 'scale'),
    ...
    ('\,\,\,\,SPS\\textsubscript{VAE}, $K$=0 (Ablation)', 'scale_singleInst_1dim_noSymm_0'),
