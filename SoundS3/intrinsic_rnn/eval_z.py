...
import os
import torch
from trainer import save_spectrogram, tensor2spec, norm_log2, norm_log2_reverse, LOG_K
...
MODEL_PATH = os.path.join(exp_path, t_config.CONFIG['model_path'])
...
class TestUI:
    def __init__(self):
        ...
        self.dataset = Dataset(
            WAV_PATH, CONFIG ,cache_all=False,
        )
